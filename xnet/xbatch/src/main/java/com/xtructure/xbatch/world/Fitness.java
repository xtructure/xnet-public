 ...
 * @param <F>
 */
public interface Fitness<F extends XTime.Phase<F>> extends XComponent<F> {
	public interface FitnessFactory<F extends XTime.Phase<F>> {
		Fitness<F> newInstance(XId id);
	}
