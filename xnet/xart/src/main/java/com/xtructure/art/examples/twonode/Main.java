 ...
 */
public final class Main extends AbstractStandardXSimulation {
	...
	static {
		...
		RESOURCE_DIR = new File(Main.class//
				.getResource("/com/xtructure/art/examples/twonode/config")//
				.getFile());
	...
	public static void main(String[] args) {
		...
		options.addOption("test", false, "run integration test (non-gui, ignores networkFile and inputFile options)");
		...
		try {
			...
			if (cl.hasOption("test")) {
				...
				new Main(networkFile, inputFile);
			}
	...
	private static void loadConfigFiles(File dir, File... ignoreFiles) {
		...
		PROCESS: for (File file : dir.listFiles()) {
			...
			try {
				try {
					XmlReader.read(file, XmlBinding.builder().add(NodeConfiguration.XML_BINDING).add(LinkConfiguration.XML_BINDING).add(NetworkImpl.XML_BINDING).newInstance());
	 ...
	 * @throws IOException
	 */
	public Main(File networkFile, File inputFile) throws XMLStreamException, IOException {
		super(SIM_ID);
	...
	public Main() {
		...
		NodeConfiguration nodeConfig = NodeConfiguration.builder()//
				.setEnergy(Range.getInstance(0.0f, 6.0f), Range.getInstance(3.0f, 3.0f))//
				...
				.newInstance();
		LinkConfiguration exLinkConfig = LinkConfiguration.builder()//
				.setCapacity(Range.getInstance(0.0f, 3.0f), Range.getInstance(1.0f, 1.0f))//
				.setCapacityAttack(Range.getInstance(0.005f, 0.005f), null)//
				.setCapacityDecay(Range.getInstance(0.001f, 0.001f), null)//
				.setStrength(Range.getInstance(0.0f, 3.0f), Range.getInstance(1.0f, 1.0f))//
				...
				.newInstance();
		LinkConfiguration inLinkConfig = LinkConfiguration.builder()//
				.setCapacity(Range.getInstance(0.0f, 3.0f), Range.getInstance(1.0f, 1.0f))//
				.setCapacityAttack(Range.getInstance(0.005f, 0.005f), null)//
				.setCapacityDecay(Range.getInstance(0.001f, 0.001f), null)//
				.setStrength(Range.getInstance(0.0f, 3.0f), Range.getInstance(1.0f, 1.0f))//
		...
		XId link12CapacityId = Link.Fragment.CAPACITY.generateExtendedId(link12Id);
		XId link12StrengthId = Link.Fragment.STRENGTH.generateExtendedId(link12Id);
		XId link21CapacityId = Link.Fragment.CAPACITY.generateExtendedId(link21Id);
		XId link21StrengthId = Link.Fragment.STRENGTH.generateExtendedId(link21Id);
		...
		List<Float> node1Energy = Arrays.asList(3.000000f, 1.850010f, 1.132515f, 0.688972f, 0.412555f, 0.239586f, 0.131735f, 0.065323f, 0.025398f, 0.002367f);
		List<Float> node2Energy = Arrays.asList(3.000000f, 2.599980f, 2.051228f, 1.561082f, 1.166436f, 0.861288f, 0.629996f, 0.456727f, 0.327996f, 0.233027f);
		List<Float> link12Capacity = Arrays.asList(1.000000f, 1.044000f, 1.067006f, 1.077554f, 1.081854f, 1.083179f, 1.083127f, 1.082459f, 1.081526f, 1.080486f);
		List<Float> link12Strength = Arrays.asList(1.000000f, 0.750000f, 0.663449f, 0.641663f, 0.651332f, 0.678554f, 0.716455f, 0.761173f, 0.810324f, 0.862342f);
		List<Float> link21Capacity = Arrays.asList(1.000000f, 1.044000f, 1.067006f, 1.077554f, 1.081854f, 1.083179f, 1.083127f, 1.082459f, 1.081526f, 1.080486f);
		List<Float> link21Strength = Arrays.asList(1.000000f, 0.750000f, 0.607202f, 0.536001f, 0.506204f, 0.501252f, 0.512238f, 0.534124f, 0.563852f, 0.599434f);
		NodeTracer nt1 = NodeTracer.getInstance(nodeTracerId.createChild(1), this, node1, node1Energy, 0.000001f);
		NodeTracer nt2 = NodeTracer.getInstance(nodeTracerId.createChild(2), this, node2, node2Energy, 0.000001f);
		LinkTracer lt121 = LinkTracer.getInstance(linkTracerId.createChild(121), this, link12, link12Capacity, 0.000001f);
		LinkTracer lt122 = LinkTracer.getInstance(linkTracerId.createChild(122), this, link12, link12Strength, 0.000001f);
		LinkTracer lt211 = LinkTracer.getInstance(linkTracerId.createChild(211), this, link21, link21Capacity, 0.000001f);
		LinkTracer lt212 = LinkTracer.getInstance(linkTracerId.createChild(212), this, link21, link21Strength, 0.000001f);
		addComponent(nt1);
		addComponent(nt2);
		addComponent(lt121);
		addComponent(lt122);
	...
	private static class SimGui extends AbstractXSimulationGui<StandardXClock.StandardTimePhase> {
		/**  */
