...
public final class UTestHasSizeAtLeastCondition_XML extends AbstractXmlFormatTest<HasSizeAtLeastCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(new HasSizeAtLeastCondition(1));
	}

	protected UTestHasSizeAtLeastCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(HasSizeAtLeastCondition t) {
