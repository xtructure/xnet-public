...
public class UTestIsEqualToCondition_XML  extends AbstractXmlFormatTest<IsEqualToCondition>{
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(isEqualTo(Object.class));
	}

	protected UTestIsEqualToCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(IsEqualToCondition t) {
