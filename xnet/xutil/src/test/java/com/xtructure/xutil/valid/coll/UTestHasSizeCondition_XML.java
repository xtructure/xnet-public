...
public final class UTestHasSizeCondition_XML extends AbstractXmlFormatTest<HasSizeCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(new HasSizeCondition(1));
	}

	protected UTestHasSizeCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(HasSizeCondition t) {
