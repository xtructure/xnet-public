...
public class UTestHasValuesCondition_XML extends AbstractXmlFormatTest<HasValuesCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new HasValuesCondition(DummyQuantityCondition.ALL, isNotNull()),//
				new HasValuesCondition(5, matches("asdf")),//
				new HasValuesCondition(1, isLessThanOrEqualTo(5)));
	}

	protected UTestHasValuesCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(HasValuesCondition t) {
