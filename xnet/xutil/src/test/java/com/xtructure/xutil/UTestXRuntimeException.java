...
public class UTestXRuntimeException {
	public UTestXRuntimeException() {}

	@Test(dataProvider = "formatArgs")
	public final void constructorSucceeds(String format, Object[] args) {
		TextXRuntimeException ex = new TextXRuntimeException(format, args);
		assertThat("", //
				ex, isNotNull());
	}
	...
	public final void constructorSucceeds(Throwable cause, String format, Object[] args) {
		TextXRuntimeException ex = new TextXRuntimeException(cause, format, args);
		assertThat("", //
				ex, isNotNull());
	}
	...
	private static class TextXRuntimeException extends XRuntimeException {
		 ...
		 * @param args
		 */
		protected TextXRuntimeException(String format, Object[] args) {
			super(format, args);
		 ...
		 * @param args
		 */
		protected TextXRuntimeException(Throwable cause, String format, Object[] args) {
