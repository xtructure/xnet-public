...
public class UTestIsGreaterThanOrEqualToCondition_XML extends AbstractXmlFormatTest<IsGreaterThanOrEqualToCondition<?>> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new IsGreaterThanOrEqualToCondition<String>("string"),//
				new IsGreaterThanOrEqualToCondition<Double>(5.0),//
				new IsGreaterThanOrEqualToCondition<Integer>(5));
	}

	protected UTestIsGreaterThanOrEqualToCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(IsGreaterThanOrEqualToCondition<?> t) {
