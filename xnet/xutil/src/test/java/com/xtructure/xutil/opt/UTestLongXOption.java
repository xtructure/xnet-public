...
public class UTestLongXOption {
	public void constructorSucceeds() {
		assertThat("",//
				new LongXOption("name", "opt", "longOpt", "description"),//
				isNotNull());
	}

	public void processValueReturnsExpectedObject() throws ParseException {
		XOption<?> opt = new LongXOption("name", "opt", "longOpt", "description");
