...
public class UTestNotCondition_XML extends AbstractXmlFormatTest<NotCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new NotCondition(isNotEmpty()),//
				new NotCondition(new OrCondition(isNotNull(), isNotEmpty(), everyElement(isNotNull()))));
	}

	protected UTestNotCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(NotCondition t) {
