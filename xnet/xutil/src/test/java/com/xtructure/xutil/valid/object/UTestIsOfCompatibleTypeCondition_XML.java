...
public class UTestIsOfCompatibleTypeCondition_XML extends AbstractXmlFormatTest<IsOfCompatibleTypeCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(isOfCompatibleType(Object.class));
	}

	protected UTestIsOfCompatibleTypeCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(IsOfCompatibleTypeCondition t) {
