...
public class UTestOrCondition_XML extends AbstractXmlFormatTest<OrCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new OrCondition(isNotNull(), isNotEmpty(), everyElement(isNotNull())));
	}

	protected UTestOrCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(OrCondition t) {
