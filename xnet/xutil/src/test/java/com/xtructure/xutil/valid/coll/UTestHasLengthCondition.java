...
public final class UTestHasLengthCondition {
	...
	static {
		...
		LENGTH = 1;
		SAT = one;
		UNSAT = TestUtils.unionData(bad, zero, two);
	}
	...
	public void toStringReturnsExpectedObject() {
		assertThat("",//
				new HasLengthCondition(LENGTH).toString(),//
				isEqualTo(String.format("must have length %d", LENGTH)));
	}
}
