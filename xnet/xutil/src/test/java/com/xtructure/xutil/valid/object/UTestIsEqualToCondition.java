...
public class UTestIsEqualToCondition {
	...
	public void constructorSucceeds(Object value) {
		if (new IsEqualToCondition(value) == null) {
	...
	public void isSatisfiedByReturnsExpectedBoolean(Object o1, Object o2) {
		if (new IsEqualToCondition(o1).isSatisfiedBy(o2)) {
			if (!MiscUtils.equals(o1, o2)) {
				throw new AssertionError();
			}
		} else {
			if (MiscUtils.equals(o1, o2)) {
	...
	public void toStringReturnsExpectedString(Object value) {
		if (!String.format("must be equal to %s", value).equals(new IsEqualToCondition(value).toString())) {
			throw new AssertionError();
		}
	}
}
