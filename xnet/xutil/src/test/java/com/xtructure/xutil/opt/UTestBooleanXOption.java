...
public class UTestBooleanXOption {
	public void constructorSucceeds() {
		assertThat("",//
				new BooleanXOption("name", "opt", "longOpt", "description"),//
				isNotNull());
	}

	public void processValueReturnsExpectedObject() throws ParseException {
		XOption<?> opt = new BooleanXOption("name", "opt", "longOpt", "description");
