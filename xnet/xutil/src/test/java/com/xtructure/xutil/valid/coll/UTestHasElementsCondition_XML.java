...
public class UTestHasElementsCondition_XML extends AbstractXmlFormatTest<HasElementsCondition> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new HasElementsCondition(DummyQuantityCondition.ALL, isNotNull()),//
				new HasElementsCondition(5, matches("asdf")),//
				new HasElementsCondition(1, isLessThanOrEqualTo(5)));
	}

	protected UTestHasElementsCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(HasElementsCondition t) {
