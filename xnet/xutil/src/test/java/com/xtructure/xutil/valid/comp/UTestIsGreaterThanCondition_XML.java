...
public class UTestIsGreaterThanCondition_XML extends AbstractXmlFormatTest<IsGreaterThanCondition<?>> {
	private static final Object[][]	INSTANCES;
	static {
		INSTANCES = TestUtils.createData(//
				new IsGreaterThanCondition<String>("string"),//
				new IsGreaterThanCondition<Double>(5.0),//
				new IsGreaterThanCondition<Integer>(5));
	}

	protected UTestIsGreaterThanCondition_XML() {
		super(null);
	}

	@Override
	protected String generateExpectedXMLString(IsGreaterThanCondition<?> t) {
