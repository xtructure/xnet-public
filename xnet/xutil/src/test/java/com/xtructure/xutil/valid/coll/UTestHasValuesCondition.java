...
public class UTestHasValuesCondition {
	...
	public void constructorSucceeds() {
		if (new HasValuesCondition(1, isNotNull()) == null) {
	...
	public void getIterableWithBadArgReturnsNull(Object object) {
		HasValuesCondition predicate = new HasValuesCondition(1, isNotNull());
	...
	public void getIterableWithGoodArgReturnsExpectedObject(Object object) {
		HasValuesCondition predicate = new HasValuesCondition(1, isNotNull());
		if (!predicate.getIterable(object).equals(((Map<?, ?>) object).values())) {
			throw new AssertionError();
		}
	}
}
