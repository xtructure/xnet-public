...
public class UTestXException {
	public UTestXException() {}

	@Test(dataProvider = "formatArgs")
	public final void constructorSucceeds(String format, Object[] args) {
		TestXException ex = new TestXException(format, args);
		assertThat("", //
				ex, isNotNull());
	}
	...
	public final void constructorSucceeds(Throwable cause, String format, Object[] args) {
		TestXException ex = new TestXException(cause, format, args);
		assertThat("", //
				ex, isNotNull());
	}
	...
	private static final class TestXException extends XException {
		 ...
		 * @param args
		 */
		protected TestXException(String format, Object[] args) {
			super(format, args);
		}
		 ...
		 * @param args
		 */
		protected TestXException(Throwable cause, String format, Object[] args) {
