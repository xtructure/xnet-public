 ...
 */
public abstract class AbstractPopulationData<D extends AbstractPopulationData<D>> extends AbstractDataXIdObject<D> implements PopulationData<D> {
	 ...
	 */
	protected AbstractPopulationData(Population<?> population, XIdObjectManager<D> manager) {
	 ...
	 */
	@Override
	protected void processObserved(XIdObjectManager<D> manager, Object... observed) {
	 ...
	 * @param population the population
	 */
	protected void processObserved(XIdObjectManager<D> manager, Population<?> population) {
		put(FITTEST_GENOME, population.getHighestGenomeByAttribute(Genome.FITNESS_ATTRIBUTE_ID).toString());
	 ...
	 * @param <D> the generic type
	 */
	public static abstract class AbstractPopulationDataFactory<D extends PopulationData<D>> implements PopulationDataFactory<D> {
		
		/* (non-Javadoc)
		 * @see com.xtructure.xevolution.tool.PopulationData.PopulationDataFactory#getOrCreateInstance(com.xtructure.xevolution.genetics.Population, com.xtructure.xutil.id.XIdObjectManager)
		 */
		@Override
