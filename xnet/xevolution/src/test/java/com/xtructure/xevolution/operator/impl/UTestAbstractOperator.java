...
public class UTestAbstractOperator {
	...
	public void constructorSucceeds() {
		assertThat("",//
				new DummyOperator(new GeneticsFactoryImpl(EVOLUTION_FIELD_MAP, "asdf")),//
				isNotNull());
	}

	public void getGeneticsFactoryReturnsExpectedObject() {
		GeneticsFactory<String> geneticsFactory = new GeneticsFactoryImpl(EVOLUTION_FIELD_MAP, "asdf");
		assertThat("",//
				new DummyOperator(geneticsFactory).getGeneticsFactory(),//
				isSameAs(geneticsFactory));
	}
}
